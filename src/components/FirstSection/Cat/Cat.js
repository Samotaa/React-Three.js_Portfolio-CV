  ...
  return (
    ...
    <group {...props} dispose={null}>
      ...
      <mesh 
        ...
        position={[-2.12, 0.04, 2.75]} 
        scale={0.74} />
      <mesh 
      onClick={() =>  window.open("https://github.com/Samotaa")} 
      geometry={nodes.Text002.geometry} 
      material={nodes.Text002.material} 
      position={[0.58, 0.04, 3.01]} 
      scale={0.83} />
      <mesh onClick={() =>  window.open("https://t.me/anjesus")} geometry={nodes.Text004.geometry} material={nodes.Text004.material} position={[-1.1, 0.04, 3.64]} scale={0.65} />
      </group>
